...
from agent import Agent as PPO_Agent
...
# LOAD MODEL
policy = PPO_Agent(state_size, action_size, 5)
policy.policy.load_state_dict(torch.load('ppo/model_checkpoint.policy'))

my_observation_builder = TreeObservation(max_depth=1)
action_dict = dict()
#====================E====================
